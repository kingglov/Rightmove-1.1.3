                ...
                <ul class="navbar-nav navbar-right ">
                 ...
                 <form  action="login" method="POST">
                    ...
                    <form action="sell" method="post">
                            <button   class="btn mr-1 mt-1 nav-link btn btn-outline-secondary"   type="submit"   >Post Property</button>
                        </form>
                    </li>
                </ul>
                <!-- LOGIN MODAL -->
...
<form  align="center" action="search" >
    ...
    <h4 class="form-signin-heading">Search properties for sale and to rent in INDIA</h4>
     

  
       <input  name="city" size="55" placeholder="e.g. &#39; Tirupathi&#39;, &#39;Chennai&#39; Or &#39;Banglore&#39; " type="text" />
  
      <button   class="btn btn-primary" type="submit"   >For sale</button>
